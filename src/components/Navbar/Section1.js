...
function Section1() {
    ...
    return (
        <section className="flex bg-gradient-to-r pt-10 from-pink-300 via-indigo-300 to-purple-300 justify-center  ">
            <div className="flex flex-column w-35 p-10 space-x-8">
