...
export const questions = [
    //I/E
    {
        ...
        answerOptions: [
            { text: 'easy to approach', score: 1 },
            { text: 'somewhat reserved', score: 0 },
        ],
    },
    ...
    //     answerOptions: [
    //       { text: 'rational decisions', score: 1 },
    //       { text: 'emotional decisions', score: 0 },
    //     ],
    //   },

    {
        ...
        answerOptions: [
            { text: 'Interact with many, including strangers', score: 1 },
            { text: '. Interact with a few, known to you', score: 0 },
        ],
    },

    {
        id: 'mbti-I/E-question3',
        text: 'In phone calls do you:',
        answerOptions: [
            { text: 'Rarely question that it will all be said', score: 1 },
            { text: '. Rehearse what you’ll say', score: 0 },
        ],
    },

    {
        id: 'mbti-I/E-question4',
        text: 'Does new and non-routine interaction with others:',
        answerOptions: [
            { text: 'stimulate and energize you', score: 1 },
            { text: ' tax your reserves', score: 0 },
        ],
    },

    {
        ...
        text: '. Do you prefer:',
        answerOptions: [
            { text: ' many friends with brief contact', score: 1 },
            { text: ' a few friends with more lengthy contact ', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'keep abreast of others happenings.', score: 1 },
            { text: ' get behind on the news. ', score: 0 },
        ],
    },

    {
        ...
        text: ' Do you:',
        answerOptions: [
            { text: 'speak easily and at length with strangers.', score: 1 },
            { text: ' find little to say to strangers. ', score: 0 },
        ],
    },
    ...
    // S/N
    {
        ...
        answerOptions: [
            { text: ' Sensible people', score: 1 },
            { text: 'Imaginative people', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: ' What is actual', score: 1 },
            { text: 'What is possible', score: 0 },
        ],
    },
...

    {
        ...
        text: ' Writers should:',
        answerOptions: [
            { text: 'Say what they mean and mean what they say', score: 1 },
            { text: 'Express things more by use of analogy', score: 0 },
        ],
    },

    {
        ...
        text: '. Facts:',
        answerOptions: [
            { text: 'Speak for themselves', score: 1 },
            { text: 'Illustrate principles', score: 0 },
        ],
    },
    {
        ...
        answerOptions: [
            { text: 'somewhat annoying', score: 1 },
            { text: 'rather fascinating', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'make themselves useful enough.', score: 1 },
            { text: 'exercise their fantasy enough.', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'see how others are useful.', score: 1 },
            { text: 'see how others see.', score: 0 },
        ],
    },

    //J/P
    {
        id: 'mbti-J/P-question15',
        text: 'Do you prefer to work:',
        answerOptions: [
            { text: 'To deadlines', score: 1 },
            { text: 'Just “whenever”', score: 0 },
        ],
    },

    {
        id: 'mbti-J/P-question16',
        text: 'Does it bother you more having things:',
        answerOptions: [
            { text: 'Incomplete', score: 1 },
            { text: 'Completed', score: 0 },
        ],
    },

    {
        id: 'mbti-J/P-question17',
        text: 'Should one usually let events occur:',
        answerOptions: [
            { text: 'by careful selection and choice', score: 1 },
            { text: 'randomly and by chance', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'final and unalterable statement', score: 1 },
            { text: 'tentative and preliminary statement', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'Re-negotiable', score: 1 },
            { text: ' random and circumstantial', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'contracted.', score: 1 },
            { text: ' done on a casual basis.', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: ' deliberate than spontaneous.', score: 1 },
            { text: 'spontaneous than deliberate.', score: 0 },
        ],
    },

    //T/F
    {
        id: 'mbti-T/F-question22',
        text: 'In judging others are you more swayed by:',
        answerOptions: [
            { text: 'Laws than circumstances', score: 1 },
            { text: 'Circumstances than laws', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: ' a cool-headed person', score: 1 },
            { text: ' a warm-hearted person', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'Unjust', score: 1 },
            { text: ' Merciless', score: 0 },
        ],
    },

    {
        id: 'mbti-T/F-question25',
        text: 'In making decisions do you feel more comfortable with:',
        answerOptions: [
            { text: 'Standards', score: 1 },
            { text: 'Feelings', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'your head', score: 1 },
            { text: ' your heart', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: 'Fair-minded.', score: 1 },
            { text: ' Sympathetic.', score: 0 },
        ],
    },

    {
        ...
        answerOptions: [
            { text: ' Objective.', score: 1 },
            { text: 'personal', score: 0 },
        ],
    },

    {
        id: 'mi-question1',
        text: 'I enjoy crosswords and other word games like Scrabble',
        answerOptions: [
            { text: '1', score: 1 },
            { text: '2', score: 2 },
            { text: '3', score: 3 },
    ...
    {
        id: 'mi-question3',
        text: 'I find it easy to explain things to others',
        answerOptions: [
            { text: '1', score: 1 },
            { text: '2', score: 2 },
            { text: '3', score: 3 },
    ...
    {
        id: 'mi-question8',
        text: 'I can picture scenes in my head when I remember things.',
        answerOptions: [
            { text: '1', score: 1 },
            { text: '2', score: 2 },
            { text: '3', score: 3 },
    ...
    {
        id: 'mi-question15',
        text: 'I enjoy learning about different culture',
        answerOptions: [
            { text: '1', score: 1 },
            { text: '2', score: 2 },
            { text: '3', score: 3 },
    ...
    {
        id: 'mi-question28',
        text: 'I like to think through problems while I walk or run',
        answerOptions: [
            { text: '1', score: 1 },
            { text: '2', score: 2 },
            { text: '3', score: 3 },
    ...
    {
        id: 'mi-question36',
        text: 'Studying history and ancient culture helps give me perspective',
        answerOptions: [
            { text: '1', score: 1 },
            { text: '2', score: 2 },
            { text: '3', score: 3 },
